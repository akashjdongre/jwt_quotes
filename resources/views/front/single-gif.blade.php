...
<div class="container">
        <div class="row">
            <div class="col-sm-6 sitemap">
                ...
                <a href="#" class="text-theme2">Latest GIF</a>
                <a class="text-theme2"><b>&nbsp;&nbsp;⤏&nbsp;&nbsp;</b></a>
                    ...
                    <div class="card card-clr">
                        <div class="card-body">
                            <div class="row justify-content-center mt-4" id="gallery">
                                <a  href="{{asset('storage/image/'.$singleQuote->gif)}}">
                                    <img id="myImg" src="{{asset('storage/image/'.$singleQuote->gif)}}" class="img-fix-wid" alt="{{$singleQuote->alt}}"/><!--img-fluid-->
                                </a>
                                <!---light gallery model--->
                                @if(isset($allRelatePictures) && !empty($allRelatePictures))
                                    @foreach($allRelatePictures as $key => $pictures)
                                        <a style="display:none" href="{{asset('storage/image/'.$pictures->gif)}}">
                                            <img src="{{asset('storage/image/'.$pictures->gif)}}" alt="{{$pictures->alt}}" />
                                        </a>
                                    @endforeach
                                 @endif
                            ...
                            <div class="row social-box mt-4">
                                <div class="col-sm-7 justify-content-center flex2 social-big" id="quotes">
                                    <p>
                                       ...
                                       <a href="https://www.facebook.com/share.php?u={{ request()->getSchemeAndHttpHost() }}/gif/{{ $singleQuote->url }}&quote={{$singleQuote->text}}" data-share="fb" data-id="{{$singleQuote->id}}" class="shareRedirect" target="_blank"><span class="fa fa-facebook-square"></span>&nbsp;{{$singleQuote->socials->facebook}}</a>
                                       <a href="https://twitter.com/intent/tweet?text={{$singleQuote->text}}&url={{ request()->getSchemeAndHttpHost() }}/gif/{{ $singleQuote->url }}" data-share="tw" data-id="{{$singleQuote->id}}" class="shareRedirect" target="_blank"><span class="fa fa-twitter-square"></span>&nbsp;{{$singleQuote->socials->twitter}}</a>
                                       <a href="https://www.linkedin.com/sharing/share-offsite/?url={{ request()->getSchemeAndHttpHost() }}/gif/{{ $singleQuote->url }}" data-share="ln" data-id="{{$singleQuote->id}}" class="shareRedirect" target="_blank"><span class="fa fa-linkedin-square"></span>&nbsp;{{$singleQuote->socials->linkedin}}</a>
                                       <a href="https://web.whatsapp.com:/send?text={{$singleQuote->text}} {{ request()->getSchemeAndHttpHost() }}/gif/{{ $singleQuote->url }} - via Quotes Lluvia" rel="tooltip" data-original-title="whatsapp" data-placement="left" data-action="share/whatsapp/share" data-share="wa"  data-id="{{$singleQuote->id}}" class="shareRedirect wpp-icon-web" target="_blank">
                                            <span class="fa fa-whatsapp wpp-icon-web"></span>&nbsp;{{$singleQuote->socials->whatsapp}}
                                        </a>
                                        <a href="whatsapp://send?text={{$singleQuote->text}} {{ request()->getSchemeAndHttpHost() }}/gif/{{ $singleQuote->url }} - via Quotes Lluvia" rel="tooltip" data-original-title="whatsapp" data-placement="left" data-action="share/whatsapp/share" data-share="wa"   data-id="{{$singleQuote->id}}" class="shareRedirect wpp-icon" target="_blank">
...
<section>
    <div class="container">
        <div class="row pt-5">
            <div class="col-sm-12">
                <h4 class="h2-style text-theme">Related GIF</h4>
            </div>
        </div>
