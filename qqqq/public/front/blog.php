...
<div class="container">
   <div class="sitemap">
           ...
           <a class="text-gray">Blog</a>
       </div>
       <h1 class="pt-1 pb-3 theme-h1"><span class="h2-style"></span>Blog</h1>
    <div class="row">
        <div class="col-sm-8">
                <div class="row blog">
                        <!---------blog end----------->
                        <div class="col-12 col-sm-4 col-md-6 col-lg-6">
                            <div class="card">
                                <a href="blogread1.php"><img class="card-img" src="https://s3.eu-central-1.amazonaws.com/bootstrapbaymisc/blog/24_days_bootstrap/pasta.jpg" alt="Bologna"></a>
                                <div class="card-img-overlay">
                                    <a href="readblog.php" class="btn btn-light btn-sm">Cooking</a>
                                </div>
                                <div class="card-body">
                                    <h4 class="card-title">Pasta with Prosciutto</h4>
                                    <small class="text-muted cat">
                                        <i class="fa fa-clock-o text-info"></i> 30 minutes
                                    ...
                                    <a href="readblog.php" class="read-more">Read More...</a>
                                </div>
                        ...
                        <div class="col-12 col-sm-4 col-md-6 col-lg-6">
                            <div class="card">
                                <a href="blogread.php"><img class="card-img" src="https://s3.eu-central-1.amazonaws.com/bootstrapbaymisc/blog/24_days_bootstrap/pasta.jpg" alt="Bologna"></a>
                                <div class="card-img-overlay">
                                    <a href="readblog.php" class="btn btn-light btn-sm">Cooking</a>
                                </div>
                                <div class="card-body">
