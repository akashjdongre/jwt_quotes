...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.authors.update", [$author->custom_id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            ...
                            <div class="col-md-5">
                                <div class="form-group avatar-upload">
                                    ...
                                    <div class="avatar-preview">
                                       <div id="imagePreview" style="background-image: url({{ (!empty($author->image)) ? asset('storage/authors/'.$author->image) : asset('image/author-avatar.png')}});"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-7">
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name',$author->name) }}" required placeholder="Enter Your Full Name">
                                    @if($errors->has('name'))
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ $errors->has('url') ? 'is-invalid' : '' }}" type="text" name="url" id="url" value="{{ old('url', $author->url) }}" required>
                                    @if($errors->has('url'))
                                ...
                                <div class="form-group">
                                <label class="required" for="status">{{ trans('cruds.author.fields.status') }}</label>
                                <select name="status" class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}">
                                <option value="1" @if($author) @if($author->status == 1) selected @endif @endif>Active</option>
                                <option value="2" @if($author) @if($author->status == 2) selected @endif @endif>Deactive</option>
                                </select>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('meta_title') ? 'is-invalid' : '' }}" type="text" name="meta_title" id="meta_title" value="{{ old('meta_title', $author->meta_title) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('picture_meta_title') ? 'is-invalid' : '' }}" type="text" name="picture_meta_title" id="picture_meta_title" value="{{ old('picture_meta_title', $author->picture_meta_title) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('meta_author') ? 'is-invalid' : '' }}" type="text" name="meta_author" id="meta_author" value="{{ old('meta_author', $author->meta_author) }}">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control {{ $errors->has('meta_keywords') ? 'is-invalid' : '' }}" type="text" name="meta_keywords" id="meta_keywords" >{{ old('meta_keywords', $author->meta_keywords) }}</textarea>
                    ...
                    <div class="form-group">
                            ...
                            <textarea class="form-control {{ $errors->has('meta_desc') ? 'is-invalid' : '' }}" type="text" name="meta_desc" id="meta_desc" >{{ old('meta_desc', $author->meta_desc) }}</textarea>
                    ...
                    <div class="form-group">
                            ...
                            <textarea class="form-control {{ $errors->has('picture_meta_desc') ? 'is-invalid' : '' }}" type="text" name="picture_meta_desc" id="picture_meta_desc" >{{ old('picture_meta_desc', $author->picture_meta_desc) }}</textarea>
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 border-left">
                    <div class="form-group">
                        ...
                        <div class="col-md-12 mb-2" >
                            <img width="500" height="300" id="image_preview_default" src="{{ !empty($author->meta_image) ? asset('storage/authors/'.$author->meta_image) : asset('image/nopreview.jpg')  }}"
                    ...
                    <div class="form-group">
                            ...
                            <textarea name="about" id="about" class="{{ $errors->has('about') ? 'is-invalid' : '' }}" >{{ old('about', $author->about) }}</textarea>
                    @if($errors->has('about'))
