...
<head>
    ...
    <link href="{{ asset('dashboard/css/adminltev3.css') }}" rel="stylesheet" />
...
<body class="sidebar-mini layout-fixed" style="height: auto;">
    <div class="wrapper">
        ...
        <footer class="main-footer">
            ...
            <input type="hidden" name="preview-file" id="preview-file" value="{{ asset('image/nopreview.jpg') }}">
    ...
    <!-- <script src="{{ asset('dashboard/js/chosen.order.jquery.min.js') }}"></script> -->
  ...
  // let colvisButtonTrans = 'ColumnVise'
  ...
  $.fn.dataTable.ext.classes.sPageButton = '';
    ...
    <script>
        ...
        $('.close-click').click(function(){   
            ...
            var preview = $('#preview-file').val();
            $(this).css('display','none');
            $(this).parent('.img_wrp').siblings('input').val('');
            $(this).siblings('img').attr('src',preview);
    ...
    <script>
            ...
            var input = $(this).parent(".pswd-input").find('.password');
    ...
    <script>
        ...
        $(".chosen-select").on('change',function(){
            ...
            $(this).parent('.form-group').find(".hidden-class").val(results);
