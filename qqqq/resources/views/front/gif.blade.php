@foreach($quotes as $quote)
    <div class="col-sm-4 text-center">
        <div class="img-shadow2">
            <a href="{{route('single-gif',['url'=>$quote->url])}}"><img src="{{asset('storage/image/'.$quote->gif)}}" class="img-fluid" alt="{{$quote->alt}}" /></a>
            ...
            <a class="total"><span class="fa fa-heart total"></span><i>&nbsp;{{$quote->socials->total_share}}</i></a>
                <a href="https://www.facebook.com/share.php?u={{ request()->getSchemeAndHttpHost() }}/gif/{{ $quote->url }}&quote={{$quote->text}}" data-share="fb" data-id="{{$quote->id}}" class="shareRedirect" target="_blank"><span class="fa fa-facebook-square"></span><i>&nbsp;{{$quote->socials->facebook}}</i></a>
                <a href="https://twitter.com/intent/tweet?text={{$quote->text}}&url={{ request()->getSchemeAndHttpHost() }}/gif/{{ $quote->url }}" data-share="tw" data-id="{{$quote->id}}" class="shareRedirect" target="_blank"><span class="fa fa-twitter-square"></span><i>&nbsp;{{$quote->socials->twitter}}</i></a>
                ...
                <a href="https://www.linkedin.com/sharing/share-offsite/?url={{ request()->getSchemeAndHttpHost() }}/gif/{{ $quote->url }}" data-share="ln" data-id="{{$quote->id}}" class="shareRedirect" target="_blank"><span class="fa fa-linkedin-square"></span><i>&nbsp;{{$quote->socials->linkedin}}</i></a>
                <a href="https://web.whatsapp.com:/send?text={{$quote->text}} {{ request()->getSchemeAndHttpHost() }}/gif/{{ $quote->url }} - via Quotes Lluvia" rel="tooltip" data-original-title="whatsapp" data-placement="left" data-action="share/whatsapp/share" data-share="wa"  data-id="{{$quote->id}}" class="shareRedirect wpp-icon-web" target="_blank">
                    <span class="fa fa-whatsapp wpp-icon-web"></span>
                    <i class="wpp-icon-web">&nbsp;{{$quote->socials->whatsapp}}</i>
                </a>
                <a href="whatsapp://send?text={{$quote->text}} {{ request()->getSchemeAndHttpHost() }}/gif/{{ $quote->url }} - via Quotes Lluvia" rel="tooltip" data-original-title="whatsapp" data-placement="left" data-action="share/whatsapp/share" data-share="wa"   data-id="{{$quote->id}}" class="shareRedirect wpp-icon" target="_blank">
