<?php include 'other-header.php';?>
    ...
    <div class="container">
       <div class="sitemap">
           ...
           <a class="text-gray">Thoughts</a>
       </div>
       <h1 class="pt-1 pb-3 theme-h1"><span class="h2-style"></span>Thoughts</h1>
        <div class="row">
            <div class="col-sm-8">
                 <!--<search box>-->
                <div class="">
                            <form class="form-inline rambo9" action="/action_page.php">
                    ...
                    <div class="row">
                        <div class="">
                            ...
                            <ul id="tabs" class="nav nav-tabs">
                                <li class="nav-item"><a href="" data-target="#latest1" data-toggle="tab" class="nav-link small text-uppercase">Latest</a></li>
                                <li class="nav-item"><a href="" data-target="#trending-new1" data-toggle="tab" class="nav-link small text-uppercase active">Trending</a></li>
                            </ul>
                            <br>
