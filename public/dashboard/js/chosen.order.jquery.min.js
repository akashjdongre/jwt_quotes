    ...
    (b = (function () {
        ...
        return (
            ...
            (a.getFlattenedOptionsAndGroups = function (a) {
                ...
                for (
                    d = Array.prototype.filter.call(a.childNodes, function (a) {
                        var b;
                        return (
                            "OPTION" === (b = a.nodeName.toUpperCase()) ||
                            "OPTGROUP" === b
                        );
                    }),
                        b = [],
                    ...
                    if (
                        ((c = d[g]),
                        b.push(c),
                        "OPTGROUP" === c.nodeName.toUpperCase())
                    )
                        for (
            ...
            (a.forceSelection = function (a, b) {
                var c, e, f, g;
                for (
                    f = this.getFlattenedOptionsAndGroups(a), c = 0;
                    c < f.length;
            ...
            (a.getSelectionOrder = function (a) {
                ...
                for (
                    ...
                    (f = c[k]),
                        ...
                        null != e &&
                            (j = e.getAttribute(this.relAttributeName)),
                        (g = h[j]),
                        i.push(g.value);
                return i;
            }),
                                ...
                                ? ((e = g.querySelector("ul.chosen-choices")),
                                  t.push(
                                      this.insertAt(
                                          l,
                                          h,
                                          g.querySelector("ul.chosen-choices")
                                      )
                                  ))
                                : console.warn(
